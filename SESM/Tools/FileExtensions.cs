...
namespace SESM.Tools
{
    ...
    public static class FileExtensions
    {
        ...
        {
            return htmlHelper.FileHelper(ExpressionHelper.GetExpressionText(expression),
        ...
        private static MvcHtmlString FileHelper(this HtmlHelper htmlHelper, string name,
            IDictionary<string, object> htmlAttributes)
        {
