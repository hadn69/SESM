...
namespace SESM.DTO
{
    public class EntityUser
    {
        ...
        {
            get { return _administratorOf ?? (_administratorOf = new HashSet<EntityServer>()); }
            set { _administratorOf = value; }
        }

        private ICollection<EntityServer> _managerOf;
        public virtual ICollection<EntityServer> ManagerOf
        {
            get { return _managerOf ?? (_managerOf = new HashSet<EntityServer>()); }
            set { _managerOf = value; }
        }

        private ICollection<EntityServer> _userOf;
        public virtual ICollection<EntityServer> UserOf
        {
            get { return _userOf ?? (_userOf = new HashSet<EntityServer>()); }
            set { _userOf = value; }
        }
